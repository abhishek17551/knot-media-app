...
const editPostService = async(postId,content, mediaURL, mediaAlt, encodedToken) => 
...
const addCommentService = async (postId,commentData,encodedToken) => 
    await axios.post(`/api/comments/add/${postId}`,
...
const editCommentService = async (postId,commentId,commentData,encodedToken) =>     
    await axios.post(`/api/comments/edit/${postId}/${commentId}`,
        {commentData: commentData},
        {headers: { authorization: encodedToken }}
    );

export {
    editCommentService,deleteCommentService,addCommentService,
    dislikePostService,likePostService,
    editPostService,deletePostService,createPostService,
    getSinglePostService,getAllPostsService
}